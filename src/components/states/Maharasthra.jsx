...
export default function Maharasthra() {
    const images = [
      ...
      return(
        ...
        <h1 className='text-center text-red-700 h-8 uppercase'>Dekho Apala Maharastra</h1>
        <div className='w-[70%] h-[50%] m-auto rounded-lg'>
        <Carousel slides={images} />
        </div>
        <div>
          <h1 className='text-center uppercase h-10 text-red-700 p-2'>Unlimite Maharasthra</h1>
        </div>
